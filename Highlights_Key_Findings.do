...
gen weight = mult / 100
svyset fsu_serial_no [pw=weight], strata(stratum)
...
graph hbar (percent) [pw=weight] if sector == 1, over(school_type) title("Rural: Distribution by School Type") ytitle("") yscale(off) b1title("% of students") blabel(bar, format(%4.1f)) bar(1, color(blue)) bar(2, color(cranberry)) bar(3, color(green)) bar(4, color(gold)) name(rural_chart, replace)

svy: tabulate school_type if sector == 2, percent format(%7.1f)
graph hbar (percent) [pw=weight] if sector == 2, over(school_type) title("Urban: Distribution by School Type") ytitle("") yscale(off) b1title("% of students") blabel(bar, format(%4.1f)) bar(1, color(blue)) bar(2, color(cranberry)) bar(3, color(green)) bar(4, color(gold)) name(urban_chart, replace)
...
graph hbar (mean) course_fee_pct [pw=weight] if !inlist(enrolment_level, 13, 14), over(enrol_group) title("Course Fee by Enrolment Level") ytitle("") yscale(off) b1title("% of students") blabel(bar, format(%4.1f)) name(fee_level, replace)

svy: mean course_fee_pct if !inlist(enrolment_level, 13, 14), over(school_type)
graph hbar (mean) course_fee_pct [pw=weight] if !inlist(enrolment_level, 13, 14), over(school_type) title("Course Fee by School Type") ytitle("") yscale(off) b1title("% of students") blabel(bar, format(%4.1f)) name(fee_school, replace)
...
graph hbar (mean) total_school_exp [pw=weight] if !inlist(enrolment_level, 13, 14), over(school_type) title("Avg Expenditure per Student by School Type") ytitle("") yscale(off) b1title("Expenditure (in Rs.)") blabel(bar, format(%6.0f)) bar(1, color(sand)) bar(2, color(sand)) bar(3, color(sand)) bar(4, color(sand)) name(exp_type, replace)
...
graph hbar (mean) coaching_pct [pw=weight], over(enrol_group) title("Private Coaching by Enrolment Level") ytitle("") yscale(off) b1title("% of students") blabel(bar, format(%4.1f)) name(coaching_level, replace)
...
graph hbar (mean) private_coaching_exp_total [pw=weight] if sector == 1, over(enrol_group) title("Avg Coaching Expenditure by Level - Rural") ytitle("") yscale(off) b1title("Expenditure (in Rs.)") blabel(bar, format(%6.0f)) bar(1, color(sand)) bar(2, color(sand)) bar(3, color(sand)) bar(4, color(sand)) bar(5, color(sand)) name(coaching_rural, replace)

svy: mean private_coaching_exp_total if sector == 2, over(enrol_group)
graph hbar (mean) private_coaching_exp_total [pw=weight] if sector == 2, over(enrol_group) title("Avg Coaching Expenditure by Level - Urban") ytitle("") yscale(off) b1title("Expenditure (in Rs.)") blabel(bar, format(%6.0f)) bar(1, color(sand)) bar(2, color(sand)) bar(3, color(sand)) bar(4, color(sand)) bar(5, color(sand)) name(coaching_urban, replace)
